...
## 2022-03-25 Fri
### 자율성을 높이기
* 결합도가 높은 객체들의 자율성을 높이려면 객체가 서로의 세부사항에 접근하지 못하도록 하는 것이다.
  * 이렇듯 **개념적, 물리적으로 객체 내부의 세부사항을 숨기는 것을 캡슐화라고 할 수 있다**.
...
* **각 객체가 자기 자신의 문제를 스스로 해결하도록 코드를 수정하거나, 작성하는 것이 바람직**하다.
  * 그렇지 않은 경우, 각 객체는 서로의 내부에 구현된 세부사항을 알고 있어야 하므로 직관적이지 못하고 변경에도 취약하다.
